...
import com.devsenior.students.eamolinam.db.DataBaseSimulada;
import com.devsenior.students.eamolinam.model.Categorias;
import com.devsenior.students.eamolinam.service.PlatoServicio;
...
public class Menu {
    ...
    public static void Start(){
        ...
        PlatoServicio platoService = new PlatoServicio(DataBaseSimulada.getPlatos());
        int opcion;
        ...
        do {
            ...
            switch(opcion){
                case 1:
                    ...
                    break;
                case 2:
                    var top3 = platoService.menosCalorias();
                    System.out.println("Top 3 platos mas saludables:");
                    top3.forEach(System.out::println);
                    break;
                case 3:
                    var agrupados = platoService.agruparCategoria();
